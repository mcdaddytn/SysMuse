...
echo ""
echo "Cache counts:"
echo "  LLM scores:    $(find cache/llm-scores -name '*.json' 2>/dev/null | wc -l | tr -d ' ') files"
echo "  Prosecution:   $(find cache/prosecution-scores -name '*.json' 2>/dev/null | wc -l | tr -d ' ') files"
echo "  IPR:           $(find cache/ipr-scores -name '*.json' 2>/dev/null | wc -l | tr -d ' ') files"
echo "  Families:      $(find cache/patent-families/parents -name '*.json' 2>/dev/null | wc -l | tr -d ' ') files"
echo ""
