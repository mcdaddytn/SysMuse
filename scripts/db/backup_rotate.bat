...
call "%~dp0backupdb.bat" "%STAMP%" "%BACKUP_DIR%"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "Get-ChildItem $dir -Filter ($db + '_*.sql') | Where-Object { $_.LastWriteTime -lt $cut } | Remove-Item -Force -ErrorAction SilentlyContinue"
